...
public interface CartRepository extends JpaRepository<Cart, Integer> {
    @Query("SELECT new com.programming3final.bookstore.entity.CartInfoDTO(c.id as cartId, b.title as bookTitle, " +
            "b.author as bookAuthor, b.image_url as bookImage, b.price as bookPrice, b.category as bookCategory, c.quantity as bookQuantity, "
            +
    ...
    @Query("DELETE FROM Cart c WHERE " +
            "c.id IN (:itemIds)")
    void deleteAllByIdIn(@Param("itemIds") List<Integer> itemIds);
